...
let total_pagar_bruto = multiplicar ( precio_producto , cantidad_producto);
let total_pagar = multiplicar ( precio_producto , cantidad_producto);
...
if ((cuotas == 0) || (cuotas == 1)) {
    ...
    total_pagar_cuotas = dividir (total_pagar_interes, cuotas);
